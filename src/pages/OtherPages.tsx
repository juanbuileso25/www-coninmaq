              ...
              <div key={i} className="bg-white border border-zinc-200 hover:shadow-xl hover:-translate-y-1 transition-all group">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between border-t border-zinc-100 pt-4">
                    ...
                    <a href="https://wa.link/bax4s3" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 bg-[#25D366] text-white font-bold text-[12px] tracking-wide uppercase px-3 py-[6px] hover:bg-[#1aaa50] transition-colors" style={{ fontFamily: "'Oswald', sans-serif" }}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-zinc-50 border border-zinc-200 p-8">
              ...
              <div className="space-y-4">
                ...
                <button
                  type="button"
                  className="w-full bg-amber-500 text-zinc-900 font-bold text-[14px] tracking-wider uppercase py-4 hover:bg-amber-600 transition-colors"
  ...
  return (
    <div className="bg-zinc-900 min-h-[60vh] flex items-center justify-center">
      <div className="text-center px-6">
        ...
        <Link
          to="/"
          className="inline-block bg-amber-500 text-zinc-900 font-bold text-[14px] tracking-wider uppercase px-8 py-4 hover:bg-amber-600 transition-colors"
          style={{ fontFamily: "'Oswald', sans-serif" }}
        >
          ← Volver al inicio
        </Link>
