...
function PartCard({ part }: { part: Part }) {
  return (
    <Link
      ...
      className="bg-white border border-zinc-200 hover:border-amber-300 hover:shadow-[0_16px_48px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-300 group flex flex-col"
    >
      {/* Visual header */}
      <div className="h-32 bg-gradient-to-br from-zinc-800 to-zinc-900 relative overflow-hidden flex items-center justify-center">
        ...
        <Icon
          ...
          width={60}
          className="text-amber-500/20 group-hover:scale-110 group-hover:rotate-12 transition-transform duration-500"
        />
      ...
      <div className="p-4 flex flex-col flex-1">
        <p className="text-amber-500 text-[10px] font-bold tracking-[2px] uppercase mb-1">
          {part.category}
        </p>
        <h3
          ...
          {filtered.length > 0 ? (
            ...
            <div className="text-center py-20">
              ...
              <button
                ...
                className="mt-4 text-amber-500 font-semibold text-[13px] hover:underline"
              >
                Limpiar filtros
              </button>
            </div>
      ...
      <div className="bg-zinc-900 py-8 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <nav className="flex items-center gap-2 text-[11px] text-zinc-500 mb-4 flex-wrap">
            ...
            <Icon icon="mdi:chevron-right" width={12} />
            <Link to="/repuestos" className="hover:text-amber-500 transition-colors">
              Repuestos
            </Link>
            <Icon icon="mdi:chevron-right" width={12} />
            <Link
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {part.compatibility.map((c) => (
                  ...
                  >
                    <Icon icon="mdi:check-circle-outline" width={13} className="text-amber-500" />
                    {c}
                  </span>
                ))}
              </div>
            ...
            <div className="lg:sticky lg:top-24 lg:self-start space-y-4">
              <div className="bg-zinc-900 p-5">
                <p className="text-amber-500 text-[10px] font-bold tracking-[3px] uppercase mb-1">
                  N.° de parte
                </p>
                <p
