...
export default function SectionTitle({
  ...
  return (
    <div ref={ref} className={`mb-12 ${isCenter ? "text-center" : "text-left"}`}>
      <span
        className={`block text-brand-accent text-[11px] font-bold tracking-[3px] uppercase mb-3 transition-all duration-500 ${
      ...
      <div
        className={`h-[3px] bg-brand-accent mt-4 transition-all duration-700 delay-300 ${
          isCenter ? "mx-auto" : ""
        } ${inView ? "w-14" : "w-0"}`}
      />
    </div>
